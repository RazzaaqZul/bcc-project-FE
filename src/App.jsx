  ...
  return ( 
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path='/login/seller' element={<LoginSeller></LoginSeller>}></Route>
        <Route path='/register/seller' element={<RegisterSeller></RegisterSeller>}/>
        <Route path='/homepage/seller' element={<SellerHomepage></SellerHomepage>}/>
        <Route path='/login_landingPage' element={<Login_landingPage></Login_landingPage>}/>
      </Routes>
       </AuthProvider>
        </ProductProvider>
