  ...
  return (
    <section className="flex flex-col gap-10">
      ...
      <div className="flex flex-col justify-center items-center font-mulish">
        ...
        <p className="text-neutral70 font-bold text-[20px] text-center px-44">
          Saat ini, kami sedang bekerja keras pada halaman tersebut. Silakan
          ikuti akun media sosial kami untuk mendapatkan pembaruan terkait
          peluncuran halaman ini.
        </p>
      </div>
