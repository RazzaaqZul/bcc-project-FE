    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            const response = await axios.post(
                'https://gedeindra.aenzt.tech/api/v1/user/signup', JSON.stringify({fname, email, username, gender:"male", password, address, contact}),
                {
       ...
       <Navigate to='/product-list'/>
        ...
        <section >
            <div className='flex flex-col justify-center font-mulish gap-3'>
              <div>
                <h1 className='text-dimGreen text-[35px] font-bold'>Daftar sebagai Penjual</h1>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-2 font-bold'>
                ...
                <p className='py-5 font-semibold text-[15px] flex justify-center '>Sudah punya akun? <Link to='/login'>Masuk</Link> </p>
