          ...
          <div>
            ...
            >
              ...
              <div className="flex flex-col gap-2 ">
                ...
                <button className="text-black border-2 border-dimGreen  tracking-widest bg-white font-[700] text-[13px] py-[8px] px-[12px] w-full rounded-3xl flex flex-row gap-3 items-center justify-center ">
                  <img src={google} className="w-[20px]" alt="google-logo" />
            ...
            <p className="py-5 font-semibold text-[15px] flex justify-center ">
              Belum buat akun? <Link to={"/register/seller"}>Daftar</Link>
            </p>
          </div>
        </div>
      )}
