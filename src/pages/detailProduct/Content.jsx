...
const handleSubmit = async () =>{
    ...
    try {
        ...
        const response = await axios.post(`/api/v1/user/market/cart?product_id=${post.ID}`
        ,
         {
            Quantity: counts
        },  config )
    ...
    <section className='flex flex-row gap-28 font-mulish'>
       ...
       <>
        ...
        <div className='basis-1/2 flex  justify-center h-[500px]  '>
            <img src={post.product_image} alt='foto-product' className='w-[500px] rounded-3xl h-[500px] '></img>
        </div>
        
        <div className='basis-1/2 flex-col justify-center '>
            <h3 className='text-[30px] text-neutral70 font-bold'>{post.category.Name}</h3>
            ...
            <div className='flex flex-row justify-center items-center gap-6 bg-green20 rounded-3xl max-w-[150px] h-10 '>
                ...
                }} className='hover:bg-green40 h-10 duration-500 ease-in-out flex justify-center items-center basis-1/4 rounded-l-3xl text-green80 font-extrabold'>-</button>
                ...
                }} className=' hover:bg-green40 h-10 duration-500 ease-in-out  flex justify-center items-center basis-1/4  rounded-r-3xl text-green80 font-extrabold'>+</button>
            </div>
            <div className='py-7'>
            ...
            <div className='py-8'>    
                <button onClick={handleSubmit} className={`${styles.button}`}>TAMBAHKAN KE KERANJANG</button>
