  ...
  return (
    <div className='bg-dimGreen py-[40px] flex flex-row-reverse justify-center items-center px-[90px] gap-11'>
      <div className=' flex flex-col basis-1/2 text-justify  text-white font-mulish font-semibold gap-7'>
        ...
        <p className='text-[19px]'> Easy Meal adalah platform e-commerce yang menghubungkan penjual bahan makanan food waste dengan pembeli untuk mengurangi limbah makanan. Bahan makanan dibeli langsung dari petani dan produsen lokal dengan harga murah, diolah, dan dikemas agar bertahan lebih lama. Konsumen dapat memesan bahan makanan melalui platform yang mudah digunakan. Easy Meal membantu meningkatkan penghasilan para petani dan produsen lokal dengan memperluas pasar mereka melalui platform online ini.
        </p>  
      </div>
