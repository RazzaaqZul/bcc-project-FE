...
const PesananMasuk = () => {
  ...
  return (
        ...
        {pesanan.map((pesanans,i) => ( 
          <div key={`footer-link-key-${i}`} className=' rounded-3xl bg-green10  h-[300px] items-center gap-5 max-md:overflow-x-auto overflow-x-auto font-mulish p-10'>
                ...
                <div className='flex flex-col pb-10 gap-2'>
                    ...
                    <h1 className='font-bold'>{items.date}</h1>
                        <div className='flex flex-row items-center gap-8'>
                            ...
                            <img src={items.img} className="basis-[10%] w-[50px] h-[100px] bg-neutral20"></img>
                            <ul className='flex flex-col basis-[80%]'>
                                <li className='font-bold text-neutral70 text-[18px]'>{items.category}</li>
                                <li className='font-extrabold text-[20px]'>{items.name}</li>
                                <li className='font-bold text-[20px]'>{items.count} {items.satuan}</li>
                            </ul>
