    ...
    <div className='font-mulish'>
            <form onSubmit={handleSubmit}>
                <div className='flex flex-row justify-end py-4'>
                    <button className='bg-gradient-green hover:scale-110 duration-300 text-white p-3 rounded-3xl '>Simpan</button>
                </div>
              {/* fname */}
              <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                    <label className='basis-[30%] text-[15px] font-bold' htmlFor='fname'>Nama Lengkap</label>
                    <input 
                        type="text"
                        id="fname"
                        name='fname'
                ...
                <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                    <div className='basis-[30%]'>
                        ...
                        <p className='text-[10px] text-neutral70 font-extrabold'>Ini akan ditampilkan di foto profil anda</p>
                    </div>
                  ...
                  {/* email */}
                  <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                    <label className='basis-[30%] text-[15px] font-bold' htmlFor='email'>email</label>
                    <input 
                        type="text"
                        id="email"
                        name='email'
                   ...
                   {/* username */}
                   <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                    <label className='basis-[30%] text-[15px] font-bold' htmlFor='username'>Username</label>
                    <input 
                        type="text"
                        id="username"
                        name='username'
            ...
            {/* Gender */}
            <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                <label htmlFor='Gender' className='basis-[30%] text-[15px] font-bold'>
                   Gender*
                </label>
                <select  value={selected} onChange={(e) => setSelected(e.target.value)}
                 className={`${styles.input} flex justify-end items-end basis-[60%]`}>
                   ...
                   {/* password */}
                   <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                    <label className='basis-[30%] text-[15px] font-bold' htmlFor='password'>Password</label>
                    ...
                    />
                      ...
                      {/* address */}
                      <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                    <label className='basis-[30%] text-[15px] font-bold' htmlFor='password'>address</label>
                    <input 
                        type="text"
                        id="address"
                        name="address"
                    ...
                    {/* Contact */}
                    <div className='flex flex-row gap-10 w-full  border-b-[1px] border-neutral70 py-4'>
                    <label className='basis-[30%] text-[15px] font-bold' htmlFor='Contact'>Contact</label>
                    <input 
                        type="text"
                        id="Contact"
                        name="Contact"
