            ...
            <ul className="flex flex-row gap-2 items-center justify-center mr-6">
              <li>
                <img
                  src={aLogoGreen}
                  alt=""
                  className={`w-[40px] hover:animate-spin hover:duration-300`}
                />
              </li>
              <li className={`hover:text-green40 duration-500`}>
                <Link to="/product-list">Easy Meal</Link>
              </li>
            </ul>
            <li className={`hover:text-green40 duration-500`}>
              <Link to="/login_landingPage">Tentang Kami</Link>
            </li>
          </ul>
        </div>
          ...
          <ul className="text-green80 flex flex-row items-center justify-center gap-8">
            <ul className="text-[15px] flex flex-row justify-center items-center gap-2">
              <li>
                <Link
                  to="/cart"
                  className=" font-extrabold text-[17px] text-red-400 mr-[-7px]  "
                >
                  {context.cart.length}
                </Link>
              </li>
              <li>
                <img src={shoopingCart} alt="" className="w-[20px]"></img>
              </li>
              <li className={`hover:text-green40 duration-500`}>
            ...
            <ul className="text-[15px] flex flex-row justify-center items-center gap-2">
              <li>
                <img src={riwayatlogo} alt="" className="w-[20px]"></img>
              </li>
              <li className={`hover:text-green40 duration-500`}>
            ...
            <ul className="text-[15px] flex flex-row justify-center items-center gap-2">
              <li>
                <Link to="/profile">
                  <img
                    src={context.preview ? context.preview : defaultProfil}
                    alt=""
